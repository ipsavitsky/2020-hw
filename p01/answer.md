...
Этот же файл, но с красивым форматированием можно почитать [тут](https://github.com/ipsavitsky/2020-hw/blob/dev/p01/answer.md)

Все указанные программы в листингах находятся в той же директории чтобы их можно было легко воспроизвести
