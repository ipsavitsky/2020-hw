...
# options passed:  -imultiarch x86_64-linux-gnu task_18_3.c -masm=intel
...
# task_18_3.c:4: 	unsigned int i = 15;
	mov	DWORD PTR -8[rbp], 15	# i,
# task_18_3.c:5: 	unsigned int j = (int)i;
	mov	eax, DWORD PTR -8[rbp]	# tmp84, i
	mov	DWORD PTR -4[rbp], eax	# j, tmp84
# task_18_3.c:6: 	return 0;
	mov	eax, 0	# _3,
# task_18_3.c:7: }
	pop	rbp	#
	.cfi_def_cfa 7, 8
